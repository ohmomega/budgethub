...
1. Go to the **[Releases page](https://github.com/ohmomega/budgethub/releases/latest)** and download **`BudgetHub Setup 1.0.2.exe`**.
...
**2) When you run `BudgetHub.Setup.1.0.2.exe` (blue "Windows protected your PC" box):**
...
npm run dist
#  -> output: dist_electron\BudgetHub Setup 1.0.2.exe
```
...
1. ไปที่ **[หน้า Releases](https://github.com/ohmomega/budgethub/releases/latest)** แล้วดาวน์โหลด **`BudgetHub Setup 1.0.2.exe`**
...
**2) ตอนเปิดไฟล์ `BudgetHub.Setup.1.0.2.exe` (กล่องสีน้ำเงิน "Windows protected your PC"):**
- กดลิงก์ **More info**
...
npm run dist
#  -> ได้ไฟล์: dist_electron\BudgetHub Setup 1.0.2.exe
```
