...
const dict = {
  TH: {
    ...
    subtitle: 'เพิ่ม แก้ไข หรือลบแผนก เพื่อใช้จัดกลุ่มข้อมูลงบประมาณ',
    createBtn: 'เพิ่มแผนก',
    ...
    deleteConfirm: 'คุณต้องการลบแผนกนี้ใช่หรือไม่? แผนกที่ยังมีข้อมูลงบประมาณอยู่จะลบไม่ได้',
    deleteSuccess: 'ลบแผนกสำเร็จ',
    deleteHasData: 'ไม่สามารถลบแผนกได้ เนื่องจากยังมีข้อมูลงบประมาณอยู่ กรุณาลบข้อมูล/แผ่นงานของแผนกนี้ก่อน แล้วจึงลบแผนกได้',
    ...
    examplePlaceholder: 'เช่น บัญชี'
  },
  EN: {
    title: 'Departments / Categories',
    subtitle: 'Add, edit, or delete departments used to group budget data.',
    ...
    deleteConfirm: 'Delete this department? A department that still has budget data cannot be deleted.',
    deleteSuccess: 'Department deleted successfully',
    deleteHasData: 'This department cannot be deleted because it still has budget data. Remove its data / sheets first, then delete it.',
    ...
    examplePlaceholder: 'e.g. Accounting'
  }
};
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingDept) {
        ...
        // dept_code is auto-generated by the backend; the UI collects a name only.
        await api.post('/departments', { dept_name: form.dept_name.trim() });
      }
      setShowModal(false);
      fetchDepartments();
    } catch (err) {
